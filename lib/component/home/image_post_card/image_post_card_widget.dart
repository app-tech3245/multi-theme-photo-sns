...
import 'image_post_card_model.dart';
export 'image_post_card_model.dart';

class ImagePostCardWidget extends StatefulWidget {
  const ImagePostCardWidget({
    Key? key,
    required this.post,
  }) : super(key: key);
...
class _ImagePostCardWidgetState extends State<ImagePostCardWidget> {
  late ImagePostCardModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ImagePostCardModel());
                                              ...
                                              child: SingleChildScrollView(
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(
                                                      '${widget.post?.viewCount.toString()}閲覧',
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                              .bodyMedium,
